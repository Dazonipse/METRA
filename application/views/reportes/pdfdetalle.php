...
<body>
    <div style="text-align:center;">
        ...
        <p><h5 style="color:#253778; font-size:20PX;" class="negra">ARTICULO: <?php echo $Bodega['BodegaReal'][0]['ARTICULO']; ?></h5></p>
        <p><h4 style="color:#253778; font-size:15px;" class="medium"><?php echo $Bodega['BodegaReal'][0]['NAME']; ?></h4></p>
        </div>
